				...
				<div class="cart-box">
								...
								<div class="cart-group">
									...
									<div class="cart-top-items" v-for="item,index in carPanelData">
										<div class="cart-items">
											...
											<div class="operation">
												<a class="items-delete-btn" @click="delCarPanelDataHandle(item.sku_id)"></a>
											</div>
					...
					<div class="cart-bottom-bg fix-bottom" v-if="count>0">
						<div class="cart-bar-operation">
							<div>
								<div class="choose-all js-choose-all">
									<span class="blue-checkbox-new" :class="{'checkbox-on':allChecked}" @click="allCheckedGoodsHandle(allChecked)"><a></a></span>
									全选
								</div>
						...
						<div class="shipping">
							...
							<router-link tag="span" class="jianguo-blue-main-btn big-main-btn js-checkout" :class="{'disabled-btn':checkedCount<=0}" to="/checkout">
...
export default {
  ...
  methods: {
    ...
    allCheckedGoodsHandle (allChecked) {
      this.$store.commit('allCheckedGoods', allChecked)
    },
