				...
				<div class="item-box">
					<div class="gallery-wrapper">
						<div class="gallery">
							<div class="thumbnail">
								<ul>
									<li :class="{'on':index==imgIndex}" @click="tableImg(index)" v-for="img, index in itemInfo.ali_images"><img
					...
					<div class="banner">
						...
						<div class="sku-dynamic-params-panel">
							<div class="sku-dynamic-params clear">
								...
								<ul class="params-colors">
									...
									<router-link :title="color.color" :to="{name:'Item',query: {itemId:color.id}}"><img
									:src="'http://img01.smartisanos.cn/'+color.image+'20X20.jpg'"></router-link>
									</li>
								</ul>
							</div>
							<div class="sku-dynamic-params clear">
						...
						<div class="sku-status">
							<div class="cart-operation-wrapper clearfix">
								...
								<span class="gray-title-btn" @click="buyNowHandle"><a >现在购买</a></span>
							</div>
						</div>
					</div>
				</div>
...
<script>
  ...
  import prompt from '@/components/prom'
  export default {
    data () {
      return {
        itemsData,
    ...
    methods: {
      ...
      buyNowHandle () {
        let itemData = {info: this.itemInfo, count: this.count}
        this.$store.commit('buyNow', itemData)
