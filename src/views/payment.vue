	    	...
	    	<div class="content page-order-payment">
	    	    <div class="gray-box clear">
	    	        ...
	    	        <div class="box-inner order-info">
	    	            <h3>提交订单成功</h3>
	    	            <p class="payment-detail" v-if="!orderInfo.isPay">请在 <span>24 小时内</span>完成支付，超时订单将自动取消。</p>
	    	            <p class="payment-detail" v-else>我们将在您完成支付后的 72 小时内发货</p>
	    	        </div>
	    	    ...
	    	    <div class="confirm-detail">
	    	        <div class="info-title">{{orderInfo.invoiceName}}</div>
