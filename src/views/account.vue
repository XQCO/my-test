					...
					<div class="account-sidebar">
						<div class="avatar gray-box clear">
							...
							<div class="box-inner">
								...
								<router-link :to="{name: 'Account'}" exact tag="li"><a href="javascript:;" activeClass="current">我的订单</a></router-link>
								<router-link :to="{name: 'Address'}" exact tag="li"><a href="javascript:;" activeClass="current">收货地址</a></router-link>
								</ul>
							</div>
						</div>
					</div>
